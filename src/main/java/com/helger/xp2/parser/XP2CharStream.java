...
public final class XP2CharStream implements CharStream
{
  ...
  public XP2CharStream (@Nonnull final Reader aReader)
  {
    this (aReader, 1, 1, DEFAULT_BUF_SIZE);
  }

  private XP2CharStream (@Nonnull final Reader aReader,
